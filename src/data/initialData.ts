...
/**
 * Sembrado de datos de demostración.
 *
 * Por defecto **desactivado**: una instalación nueva arranca vacía para no mezclar
 * ventas/clientes de ejemplo con datos reales. Se activa con `VITE_SEED_DEMO=true`
 * (ver `.env.example`).
 */
export const DEMO_SEED_ENABLED: boolean = import.meta.env?.VITE_SEED_DEMO === 'true';

/**
 * Clientes de demostración (solo se usan cuando `DEMO_SEED_ENABLED` está activo).
 */
